...
export default function TermSheetAutocall() {

  let coupon = 7;
  let ymin = 40;
  let xmax = 10;
  let barr_capital = 60;
  let barr_anticipe = 100;
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          <View style={styles.container}>
            <Text style={{ fontSize: 30, paddingVertical: 5 }}>Autocall Incremental</Text>
            <Text style={{ fontSize: 25, paddingVertical: 5 }}>Avec airbag</Text>
          </View>
          <View style={styles.container}>
